...
def trans_parameters(model, checkpoint, verbose=True):
    ...
    for key in state_dict:
        ...
        if "module.encoder." + key in pretrained_dict :
            if pretrained_dict["module.encoder." + key].size() == state_dict["module." + key].size():
                if verbose:
                    print('====load====' + key)
                state_dict["module." + key] = pretrained_dict["module.encoder." + key]
