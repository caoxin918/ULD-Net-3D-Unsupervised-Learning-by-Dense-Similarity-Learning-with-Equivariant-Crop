...
from modules.backbone import get_graph_feature,Transform_Net
...
class get_model(nn.Module):
    def __init__(self, args, part_num=50, num_channel=3, **kwargs):
        ...
        self.transform_net = Transform_Net(args, num_channel*2)
        ...
        #                            self.bn8,
        #                            nn.LeakyReLU(negative_slope=0.2))
        self.dp1 = nn.Sequential(nn.LeakyReLU(negative_slope=0.2, inplace=True),
                                 (nn.Dropout(p=args.dropout)))

        # self.conv9 = nn.Sequential(nn.Conv1d(256, 256, kernel_size=1, bias=False),
        #                            self.bn9,
        #                            nn.LeakyReLU(negative_slope=0.2))
        self.dp2 = nn.Sequential(nn.LeakyReLU(negative_slope=0.2, inplace=True),
                                         (nn.Dropout(p=args.dropout)))
