...
def parse_args():
    ...
    parser.add_argument('--restore', action='store_true', default=True, help='restore the weights [default: False]')
...
def main(args):
    ...
    MyLogger = TrainLogger(args, name=args.model.upper(), subfold='semseg_regionEmb',
