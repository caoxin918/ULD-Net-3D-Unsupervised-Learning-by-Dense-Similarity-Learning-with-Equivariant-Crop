...
from Torch_Utility import trans_parameters, weights_init, bn_momentum_adjust, copy_parameters
...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='partseg_region0', help='log folder [default: ]')
    ...
    parser.add_argument('--restore_path', type=str, default = ''
                        , help='path to pretrained weights [default: ]')
    ...
    parser.add_argument('--scheduler', default='cos', help='learning rate scheduler [default: step]')
    parser.add_argument('--model', default='dgcnn_partseg', help='model [default: pointnet_partseg]')
    ...
    parser.add_argument('--xavier_init', action='store_true',default=True, help='Xavier weight init [default: False]')
    ...
    parser.add_argument('--normal', action='store_true', default=True, help='use normal [default: False]')
